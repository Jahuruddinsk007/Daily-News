...
export class News extends Component {
    ...
    async updateNews() {
        ...
        const url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=40a31174b2eb458bacf2eb0089a367dc&page=${this.state.page}&pageSize=${this.props.pageSize}`;
